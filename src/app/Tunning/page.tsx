...
const tuningPackages = [
  {
    ...
    description: "Reprogrammation de l'ECU pour améliorer la puissance et le couple",
    features: ["Flash ECU", "Amélioration du Filtre à Air", "Analyse de Performance"],
    powerGain: "+25-35 CV",
  ...
  },
  {
    ...
    features: ["Réglage ECU + TCU", "Admission d'Air Froid", "Système d'Échappement", "Amélioration de l'Intercooler"],
    powerGain: "+50-75 CV",
  ...
  },
  {
    ...
    description: "Performance maximale avec améliorations turbo/suralimentation",
    features: ["Amélioration Turbo/SC", "Gestion Complète du Moteur", "Amélioration du Système de Carburant", "Internes Forgés"],
...
const featuredBuilds = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1469285994282-454ceb49e63c?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80"
  }
];
  ...
  return (
    <main className="pt-20">
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-muted-foreground text-lg max-w-3xl mx-auto mb-8">
            Libérez le véritable potentiel de votre véhicule avec nos services de réglage professionnels. 
            De la reprogrammation de l&apos;ECU aux constructions de performance complètes, nous délivrons des résultats qui dépassent les attentes.
          </p>
          <div className="flex justify-center space-x-8 text-center">
            <div>
              <div className="text-3xl font-bold text-primary">200+</div>
              <div className="text-sm text-muted-foreground">Voitures Réglées</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-primary">500+</div>
              <div className="text-sm text-muted-foreground">Gain Moyen en CV</div>
            </div>
            <div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Forfaits de Réglage</h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Choisissez le forfait de performance parfait pour votre véhicule et votre style de conduite.
            </p>
          </div>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center p-3 bg-primary/10 rounded-lg">
                      <div className="font-bold text-primary">{pkg.powerGain}</div>
                      <div className="text-xs text-muted-foreground">Gain de Puissance</div>
                    </div>
                    <div className="text-center p-3 bg-primary/10 rounded-lg">
                      <div className="font-bold text-primary">{pkg.torqueGain}</div>
                      <div className="text-xs text-muted-foreground">Gain de Couple</div>
                    </div>
                  </div>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Constructions en Vedette</h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Découvrez certaines de nos constructions de performance et transformations les plus impressionnantes.
            </p>
          </div>
      ...
      <section className="py-20 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg mb-8 opacity-90 max-w-2xl mx-auto">
            Nos experts en réglage sont prêts à transformer votre véhicule en la machine que vous avez toujours voulu. 
